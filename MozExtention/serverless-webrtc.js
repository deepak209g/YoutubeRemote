...
function Peer(){
  var cfg = {},
  con = { 'optional': [{ 'DtlsSrtpKeyAgreement': true }] }
  this.pc1 = new RTCPeerConnection(cfg, con)
...
Peer.prototype.createLocalOffer = function(){
  this.setupDC()
  this.pc1.createOffer(function (desc) {
    this.pc1.setLocalDescription(desc, function () { }, function () { })
...
Peer.prototype.setupDC = function(){
...
Peer.prototype.receiveAnswer = function(answerDesc){
  console.log('Received remote answer: ', answerDesc)
  // writeToChatLog('Received remote answer', 'text-success')
  this.pc1.setRemoteDescription(answerDesc)
}

Peer.prototype.handleOffer = function(offerDesc){
  var pc2 = this.pc1
  pc2.setRemoteDescription(offerDesc)
  pc2.createAnswer(function (answerDesc) {
    writeToChatLog('Created local answer', 'text-success')
